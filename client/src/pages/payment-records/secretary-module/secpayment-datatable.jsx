...
export function createReceiptPatientRef(row) {
  ...
  switch (userRole) {
    case 2:
      patientsRoute = "/secretary/payment-records/create-receipt?patientValue=";
      break;
    case 3:
      patientsRoute = "/dentist/payment-records/create-receipt?patientValue=";
      break;
    case 4:
      patientsRoute = "/admin/payment-records/create-receipt?patientValue=";
      break;
  }
  return (
    patientsRoute +
...
const SecTransactionDataTable = (patientIDNum) => {
  ...
  const PatientIDNumber = JSON.stringify(ConvertStringApp.patientIDNum).replace(
    /"/g,
    ""
  );
