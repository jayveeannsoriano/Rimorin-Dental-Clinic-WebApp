...
const createReceipt = () => {
  ...
  if (PWDSeniorDiscount == 0) {
    ...
    discountedTotal =
      (totalAmountPaid + procedurePriceTotal) * PWDSeniorDiscount;
    finalTotal = totalAmountPaid + procedurePriceTotal - discountedTotal;
  }
  console.log(formattedDate);
                ...
                <div className="container">
                  ...
                  <div class="row">
                    ...
                    <div className="col-xl-10 col-lg-10 col-md-10 total-bill">
                      ...
                      <div
                        aria-hidden={
                          visibility !== "pwdDiscount" ? true : false
                        }
                      >
                        Subtotal: ${totalAmountPaid.toString()}
                      </div>
                      ...
                      <div
                        aria-hidden={
                          visibility !== "removeDiscount" ? true : false
                        }
                      >
