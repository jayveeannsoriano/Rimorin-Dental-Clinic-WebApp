...
const BookingConfirm = ({nextStep, prevStep, values}) => {
    ...
    Axios.post("http://localhost:3001/sendSMS", {phone: getUserPhone ,message:"Hi "+getUserName+"! This is from Rimorin Dental Clinic notifying you of your requested Appointment at "+date+" "+time+" due to '" + values.consultation + "'. See you there!"})
