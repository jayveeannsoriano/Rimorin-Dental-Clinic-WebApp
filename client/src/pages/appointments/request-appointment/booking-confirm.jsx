...
const BookingConfirm = ({nextStep, prevStep, values}) => {
    ...
    Axios.post("http://localhost:3001/insertAppointment", {userNameApp: userNameApp, startDate: date, consulInput: values.consultation, getTime:time, recep:userInfop['email']})
