    ...
    const getUserAppointments = async() => {
      try{
          ...
          if(userInfo['user_role_id']==1){
            var dataApp1 = await axios.get('http://localhost:80/getUserAppts', { params: { 
            ...
            var dataApp1 = await axios.get('http://localhost:80/getUserApptsOthers',{params:{
              pend:(checkBox1.checked==true?"Pending":""),
              acc:(checkBox2.checked==true?"Accepted":""),
              fin:(checkBox3.checked==true?"Finished":""),
              can:(checkBox4.checked==true?"No Show":"")
            }});
            var dataApp2 = await axios.get('http://localhost:80/getUserApptsReqOthers',{params:{
              pend:(checkBox1.checked==true?"Pending":""),
              acc:(checkBox2.checked==true?"Accepted":""),
              fin:(checkBox3.checked==true?"Finished":""),
              can:(checkBox4.checked==true?"No Show":"")
            }});
            var dataApp3 = await axios.get('http://localhost:80/getUserApptsHistOthers',{params:{
              pend:(checkBox1.checked==true?"Pending":""),
              acc:(checkBox2.checked==true?"Accepted":""),
              fin:(checkBox3.checked==true?"Finished":""),
              can:(checkBox4.checked==true?"No Show":"")
            ...
            var dataApp1  = await axios.get('http://localhost:80/getUserApptsDent', { params: { 
            ...
            var dataApp2  = await axios.get('http://localhost:80/getUserApptsHistDent', { params: { 
              dentistIDnumber: userInfo['dentistIDnumber'],
              pend:(checkBox1.checked==true?"Pending":""),
              acc:(checkBox2.checked==true?"Accepted":""),
              fin:(checkBox3.checked==true?"Finished":""),
