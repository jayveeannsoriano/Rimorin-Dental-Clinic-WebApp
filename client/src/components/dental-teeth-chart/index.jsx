...
const DentalChart = () => {
    ...
    const handleChangeTeeth = input => e =>{

        e.target.classList.toggle('unmarked');
                ...
                >
                    <g transform="translate(-66 -136)">
                        <path
                            ...
                            stroke-miterlimit="8"
                            fill="#FFFFFF"
                            fill-rule="evenodd" onClick={handleClick}
                        />
                        <path
                            id="root"
            ...
            <div className="dental-chart col-lg-auto col-xl-auto col-md-auto">
                ...
                <div className="row t12">
                    <svg width="32" height="65" xmlns="http://www.w3.org/2000/svg" xlinkHref="http://www.w3.org/1999/xlink">
                        <g transform="translate(-362 -132)">
                            <path id="root" d="M381.398 133.782C383.394 134.98 385.429 139.849 386.811 145.385 388.653 152.766 389.404 170.297 390.496 178.205 391.315 184.136 393.094 188.251 393.5 190.8L393.44 191.692 387.573 188.406C385.197 187.572 382.586 187.11 379.844 187.11 374.362 187.11 369.398 188.956 365.805 191.94L363.727 194.5 363.5 192.86C363.516 184.911 369.391 167.034 371.66 158.038 374.253 147.757 376.915 136.027 379.44 133.918 380.071 133.39 380.732 133.382 381.398 133.782Z" stroke="#624DE3" stroke-width="1.33333" stroke-miterlimit="8" fill="#FFFFFF" fill-rule="evenodd" onClick={handleClick} />
                        </g>
                    </svg>

                    <svg width="42" height="50" xmlns="http://www.w3.org/2000/svg" xlinkHref="http://www.w3.org/1999/xlink">
                        <g transform="translate(-358 -192)">
                            <path id="tooth" d="M371.285 239.298C367.617 237.692 363.114 235.919 361.48 231.47 359.846 227.021 360.546 218.089 361.48 212.602 362.414 207.116 363.848 201.73 367.083 198.552 370.318 195.374 376.321 193.199 380.89 193.534 385.458 193.868 391.395 195.273 394.496 200.559 397.598 205.845 399.432 219.661 399.498 225.248 399.565 230.834 397.564 231.437 394.896 234.079 392.228 236.722 386.759 240.034 383.491 241.105 380.223 242.175 374.953 240.904 371.285 239.298Z" stroke="#624DE3" stroke-width="1.33333" stroke-miterlimit="8" fill="#FFFFFF" fill-rule="evenodd" onClick={handleClick} />
                        </g>
                    </svg>
                </div>
                ...
                <div className="row t14">
                    <svg width="43" height="63" xmlns="http://www.w3.org/2000/svg" xlinkHref="http://www.w3.org/1999/xlink">
                        <g transform="translate(-212 -137)">
                            <path id="root" d="M234.715 180.033C235.755 178.009 237.022 167.818 236.275 160.913 235.528 154.009 231.693 139.868 230.23 138.606 228.768 137.345 227.533 147.602 227.501 153.345 227.468 159.087 228.963 169.046 230.035 173.063 231.108 177.079 233.675 182.058 234.715 180.033Z" stroke="#624DE3" stroke-width="1.33333" stroke-miterlimit="8" fill="#FFFFFF" fill-rule="evenodd" onClick={handleClick} />
                            <path id="root" d="M243.554 141.667C243.987 141.42 244.426 141.439 244.849 141.779 246.539 143.142 249.224 151.282 250.617 157.728 252.009 164.174 253.003 173.212 253.202 180.456 253.351 185.888 253.855 193.358 253.076 197.861L252.833 198.5 250.876 196.075C246.869 192.507 241.747 190.114 237.288 189.649 232.829 189.184 224.773 191.13 217.732 194.009L213.723 195.856 213.536 195.209C213.391 193.273 213.739 190.74 213.623 187.633 213.391 181.419 214.12 168.859 215.015 161.915 215.91 154.97 217.468 146.398 218.993 145.966 220.518 145.534 222.772 154.073 224.164 159.323 225.556 164.573 225.722 173.013 227.346 177.465 228.971 181.918 231.722 186.636 233.91 186.038 236.098 185.44 239.379 179.957 240.473 173.877 241.567 167.796 239.744 154.904 240.473 149.554 241.02 145.542 242.257 142.409 243.554 141.667Z" stroke="#624DE3" stroke-width="1.33333" stroke-miterlimit="8" fill="#FFFFFF" fill-rule="evenodd" onClick={handleClick} />
                        </g>
                    </svg>
                ...
                <div className="row t15">
                    <svg width="42" height="65" xmlns="http://www.w3.org/2000/svg" xlinkHref="http://www.w3.org/1999/xlink">
                        <g transform="translate(-138 -134)">
                            <path id="root" d="M170.011 141.657C170.938 141.252 171.98 141.595 172.895 143.1 174.724 146.11 177.738 155.475 178.788 162.766 179.839 170.057 179.5 180.559 179.195 186.847 179.043 189.991 178.941 192.976 178.649 195.388L178.237 197.5 176.284 195.984C171.849 193.142 165.721 191.385 158.953 191.385 152.184 191.385 146.057 193.142 141.621 195.984L139.852 197.358 139.5 195.588C139.513 193.335 140.122 190.442 140.173 187.047 140.275 180.258 141.969 166.378 143.019 159.555 144.069 152.732 145.186 146.879 146.474 146.11 147.761 145.341 149.759 149.956 150.742 154.939 151.724 159.923 150.979 170.826 152.368 176.01 153.756 181.194 156.94 185.509 159.074 186.044 161.208 186.579 163.783 183.402 165.172 179.221 166.56 175.04 166.967 166.712 167.407 160.96 167.848 155.207 166.899 147.682 167.814 144.705 168.271 143.217 169.084 142.063 170.011 141.657Z" stroke="#624DE3" stroke-width="1.33333" stroke-miterlimit="8" fill="#FFFFFF" fill-rule="evenodd" onClick={handleClick} />
                            <path id="root" d="M160.125 180.233C161.318 178.381 162.95 164.191 162.385 157.013 161.82 149.835 158.211 139.382 156.736 137.166 155.262 134.95 153.787 138.555 153.536 143.715 153.285 148.875 154.414 162.371 155.23 168.127 156.046 173.882 158.933 182.086 160.125 180.233Z" stroke="#624DE3" stroke-width="1.33333" stroke-miterlimit="8" fill="#FFFFFF" fill-rule="evenodd" onClick={handleClick} />
                        </g>
                    </svg>

                    <svg width="49" height="47" xmlns="http://www.w3.org/2000/svg" xlinkHref="http://www.w3.org/1999/xlink">
                        <g transform="translate(-133 -195)">
                            <path id="tooth" d="M180.111 223.972C180.078 226.87 181.232 231.578 179.715 234.245 178.197 236.911 177.405 239.216 171.004 239.973 164.603 240.731 147.215 240.928 141.309 238.788 135.403 236.648 135.964 232.598 135.568 227.133 135.172 221.668 136.525 210.934 138.934 205.996 141.342 201.057 145.598 198.917 150.02 197.501 154.441 196.085 160.908 196.25 165.461 197.501 170.014 198.752 174.93 201.781 177.339 205.008 179.748 208.234 179.385 213.469 179.913 216.861 180.44 220.252 180.144 221.075 180.111 223.972Z" stroke="#624DE3" stroke-width="1.33333" stroke-miterlimit="8" fill="#FFFFFF" fill-rule="evenodd" onClick={handleClick} />
                        </g>
                    </svg>
                </div>
                ...
                <div className="row t23">
                    ...
                    <svg width="31" height="43" xmlns="http://www.w3.org/2000/svg" xlinkHref="http://www.w3.org/1999/xlink" >
                        ...
                        <g transform="translate(-734 -405)">
                            <path id="tooth" d="M0.108739 9.00771C-0.160197 13.5603 0.00794103 22.9014 1.31895 27.8249 2.62996 32.7484 5.62193 36.4242 7.97512 38.5487 10.3283 40.6732 12.2781 41.6175 15.4381 40.5721 18.5981 39.5267 24.7164 37.2673 26.9351 32.2763 29.1538 27.2854 29.2547 15.786 28.7504 10.6264 28.2462 5.46678 28.2126 3.00508 23.9096 1.31895 19.6066-0.367178 6.83214-0.198512 2.93257 0.50961-0.967005 1.21773 0.377675 4.4551 0.108739 9.00771Z" stroke="#624DE3" stroke-width="1.33333" stroke-miterlimit="8" fill="#FFFFFF" fill-rule="evenodd" onClick={handleClick} transform="matrix(-1 0 0 1 764.5 406.5)" />
                        </g>
                    </svg>
                    <svg width="31" height="74" xmlns="http://www.w3.org/2000/svg" xlinkHref="http://www.w3.org/1999/xlink" >

                        <g transform="translate(-733 -440)">
                            <path id="root" d="M0.123334 0 0.312551 0.620492C2.81169 4.74974 8.32038 7.94585 12.4041 8.19896 15.1266 8.36777 19.9383 7.39733 24.0693 5.62993L28 3.2701 27.2854 9.33779C26.3942 15.759 25.2146 22.9818 24.5117 28.3482 23.106 39.0811 21.5329 52.8517 19.893 59.5344 18.2531 66.2172 16.9142 70.6049 14.6719 68.4448 12.4295 66.2847 8.68089 55.248 6.43854 46.5739 4.19619 37.8999 2.02067 24.9731 1.21742 16.4003 0.815794 12.1139 0.171613 7.38021 0 3.42711Z" stroke="#624DE3" stroke-width="1.33333" stroke-miterlimit="8" fill="#FFFFFF" fill-rule="evenodd" onClick={handleClick} transform="matrix(-1 0 0 1 763.5 444.5)" />
                        </g>
                    </svg>
                </div>
                <div className="row t24">
                    <svg width="35" height="45" xmlns="http://www.w3.org/2000/svg" xlinkHref="http://www.w3.org/1999/xlink" >
                        <g transform="translate(-658 -405)">
                            <path id="tooth" d="M0.164878 10.2193C0.0986557 14.6836-0.464287 23.1825 0.959546 27.8783 2.38338 32.5742 6.2905 36.0795 8.70756 38.3943 11.1246 40.7092 12.4492 42.6934 15.4622 41.7674 18.4753 40.8415 24.1043 36.6747 26.7863 32.8387 29.4682 29.0027 31.0907 23.8439 31.5543 18.7512 32.0178 13.6585 32.8456 5.35806 29.5676 2.28267 26.2896-0.792726 16.588 0.496925 11.8862 0.298509 7.18445 0.100093 3.31039-0.561293 1.35688 1.09217-0.596627 2.74564 0.2311 5.755 0.164878 10.2193Z" stroke="#624DE3" stroke-width="1.33333" stroke-miterlimit="8" fill="#FFFFFF" fill-rule="evenodd" onClick={handleClick} transform="matrix(-1 0 0 1 691.5 406.5)" />
                        </g>
                    </svg>
                    <svg width="31" height="69" xmlns="http://www.w3.org/2000/svg" xlinkHref="http://www.w3.org/1999/xlink" >
                        <g transform="translate(-661 -445)">
                            <path id="root" d="M28 0 26.7112 11.0226C25.6998 20.209 23.5084 39.8706 21.4517 48.6936 19.3951 57.5166 16.3271 63.3654 14.3717 63.9602 12.4163 64.555 11.3374 58.3757 9.71911 52.2624 8.10082 46.1492 6.21281 37.0288 4.66194 27.2806 3.88656 22.4065 2.27666 15.178 1.13461 8.59382L0 0.0633834 2.7666 2.83581C5.63334 4.7727 9.59381 5.97064 13.9683 5.97064 18.3429 5.97064 22.3033 4.7727 25.1701 2.83581Z" stroke="#624DE3" stroke-width="1.33333" stroke-miterlimit="8" fill="#FFFFFF" fill-rule="evenodd" onClick={handleClick} transform="matrix(-1 0 0 1 690.5 448.5)" />
                        </g>
                    </svg>
                </div>
            </div>
