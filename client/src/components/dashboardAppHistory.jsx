...
const DashboardTableAppHistory = () => {
    ...
    const getAppointment = async() => {
        try{
            const response = await axios.get('https://rimorin-dental-clinic.herokuapp.com/getAppointmentHistory',{
                params:{
...
export default DashboardTableAppHistory