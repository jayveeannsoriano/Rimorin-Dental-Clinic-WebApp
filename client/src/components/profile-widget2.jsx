                    ...
                    <div class="row">
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-4 col-sm-4">
                            <div class="row">
                                ...
                                <div id="birthdate" class="col-lg-auto col-md-auto pr-label">
                                    01/01/1998
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div id="address" class="col-lg-auto col-md-auto pr-label">
                                    Block4 Rivera Seth
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div id="country" class="col-lg-auto col-md-auto pr-label">
                                    2400
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-4 col-sm-4">
                            <div class="row">
                                ...
                                <div id="emailaddress" class="col-lg-auto col-md-auto pr-label">
                                    1234@email.com
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div id="city" class="col-lg-auto col-md-auto pr-label">
                                    Diaz City
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div id="gender" class="col-lg-auto col-md-auto pr-label">
                                    Female
                                </div>
                            </div>
                        </div>
