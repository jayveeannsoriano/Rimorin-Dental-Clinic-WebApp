...
function ApptDetailsFollowUp(pName,appNum,date,time,appStats,procedures) {
	...
	>
      ...
      <div className="appointment-details-modal">
          <div class="row">
            ...
            <div class="row">
            <div class="col modal-label">Follow-up Procedures:</div>
...
export default ApptDetailsFollowUp;