...
export declare type OnPageChangeFunc = (data: PageChangeData) => void;
export declare type ShowMoreMonthFunc = (data: CalendarEvent[]) => void;
export declare type OnSelectViewFunc = (view: CALENDAR_VIEW) => void;
export declare type OnEventClickFunc = (data: CalendarEvent, e: any) => void;
export declare type OnEventDragFinishFunc = (prevEvent: CalendarEvent, updatedEvent: CalendarEvent, events: any, resetPosition?: any) => void;
export declare type OnNewEventClickFunc = (data: NewEventClickData, e: any) => void;
export declare type OnStateChangeFunc = (data: KalendState) => void;
